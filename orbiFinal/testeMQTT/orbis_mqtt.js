...
// Protocolo: MQTT (leve, feito para IoT)
// ==============================
...
var MQTT_HOST  = "broker.hivemq.com"; // Broker público gratuito
var MQTT_PORT  = 1883;                // Sem SSL — sem problema de RAM
var MQTT_ID    = "esp32-orbis-01";    // ID único do dispositivo
var MQTT_TOPIC = "orbis/leituras";    // Tópico onde os dados serão publicados
